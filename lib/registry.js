...
// A number with no cell behind it — a sum across items, which has no raw cell
// to echo — in the same euro formatting a bare price gets. A list priced in
// something other than euros will still add up under a € sign; the price
// filter's bounds already read the sheet that way.
